def gen(items: scala.collection.Map[String, scala.collection.Seq[String]], v1: String, v2: String): String = {
  ...
  sb.append("; Script generated by the HM NIS Edit Script Wizard.\n")
    ...
    .append("!define PRODUCT_DIR_REGKEY \"Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\PlantsVsZombies.exe\"\n")
    ...
    .append("; Finish page\n")
    .append("!define MUI_FINISHPAGE_RUN \"$INSTDIR\\PlantsVsZombies.exe\"\n")
  ...
  sb.append("\n")
    ...
    .append("  CreateShortCut \"$SMPROGRAMS\\$ICONS_GROUP\\植物大战僵尸β版.lnk\" \"$INSTDIR\\PlantsVsZombies.exe\"\n")
    ...
    .append("  SetOutPath \"$INSTDIR\"\n")
    .append("  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application\n")
    .append("    CreateShortCut \"$DESKTOP\\植物大战僵尸β版.lnk\" \"$INSTDIR\\PlantsVsZombies.exe\"\n")
    .append("  !insertmacro MUI_STARTMENU_WRITE_END\n")
    .append("SectionEnd\n")
    .append("\n")
    ...
    .append("  WriteRegStr HKLM \"${PRODUCT_DIR_REGKEY}\" \"\" \"$INSTDIR\\PlantsVsZombies.exe\"\n")
    ...
    .append("  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} \"${PRODUCT_UNINST_KEY}\" \"DisplayIcon\" \"$INSTDIR\\PlantsVsZombies.exe\"\n")
